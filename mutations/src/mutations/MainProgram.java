...
public class MainProgram {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException, IOException, ATLCoreException {
		...
		/**Here, the names of the modules of the generic HOTs, that need to be stored in the folder HOTs,
		 * need to be given
		 */
		...
		/**Here, the name of the module of the transformation to be mutated, plus its input and output
		 * metamodels, are given. These artifacts need to be stored in the folder transformation
		 */
		 ...
		 * In our example, AddInPatternElement.atl (HOTs with Generic Mutations) needs to be injected into model -> AddInPatternElement.xmi
